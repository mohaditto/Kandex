...
// Rutas para que el líder gestione usuarios de su equipo
router.post('/:id/usuarios', ensureAuthenticated, requireAnyRole('Administrador', 'Líder'), equipoController.addUser);
router.post('/:id/usuarios/:usuarioId/delete', ensureAuthenticated, requireAnyRole('Administrador', 'Líder'), equipoController.removeUser);
